...
<html lang="en">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-info">
      ...
      <div class="container">
        <h4 class="fitur text-center">Rata-rata pengunjung perbulan</h4>
  ...
  <div class="card text-center offset-1 col-10">
    <div class="card-header">
      <ul class="nav nav-tabs card-header-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="/pengunjung/rata2">Rata-Rata</a>
        </li>
        <li class="nav-item">
    ...
    <div class="card-body">
      <div class="form-group row">
        ...
        <div class="col-3 text-left">
          <p> {{$rata2}} Orang</p>
          <hr>
          <p> {{$rata2January}} Orang</p>
          <p> {{$rata2February}} Orang</p>
          <p> {{$rata2March}} Orang</p>
          <p> {{$rata2April}} Orang</p>
          <p> {{$rata2May}} Orang</p>
          <p> {{$rata2June}} Orang</p>
          <p> {{$rata2July}} Orang</p>
          <p> {{$rata2August}} Orang</p>
          <p> {{$rata2September}} Orang</p>
          <p> {{$rata2October}} Orang</p>
          <p> {{$rata2November}} Orang</p>
          <p> {{$rata2December}} Orang</p>
        </div>
      </div>
    </div>
</div>
